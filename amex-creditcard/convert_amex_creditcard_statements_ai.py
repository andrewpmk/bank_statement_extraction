#!/usr/bin/env python3
"""Convert Amex credit card statement PDFs into CSVs using OpenRouter (model default: openai/gpt-5-mini).
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Convert Amex credit card statement PDFs with OpenRouter-assisted parsing (default: openai/gpt-5-mini).")
